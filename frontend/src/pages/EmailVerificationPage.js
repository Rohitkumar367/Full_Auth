        ...
        <div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'>
			...
			>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    {error && <p className='text-white-500 font-semibold mt-2 mx-auto'>{error}</p>}
                    ...
                    <motion.button
						...
						className='w-full bg-gradient-to-r from-red-500 to-red-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-red-600 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 disabled:opacity-50'
					>
